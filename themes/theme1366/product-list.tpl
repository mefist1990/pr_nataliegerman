{if isset($products) && $products}
  ...
  {if ($hide_left_column || $hide_right_column) && ($hide_left_column !='true' || $hide_right_column !='true')}     {* left or right column *}
     <!-- @pw здесь исправил nbItemsPerLine на 2  -->
    {assign var='nbItemsPerLineTablet' value=2}
    {assign var='nbItemsPerLineMobile' value=2}
  {elseif ($hide_left_column && $hide_right_column) && ($hide_left_column =='true' && $hide_right_column =='true')} {* no columns *}
   <!-- @pw здесь исправил nbItemsPerLine на 2 (если хотим 2 товара в строчку) или ставим 3 (если хотим 3 товара в строчку)  -->
  ...
  <!--@PW НАЧАЛО div для двух плиток, для работы с js pw-two-three-tiles.js -->
  <div>
  <!-- Products list -->
...
<!--@PW КОНЕЦ div для двух плиток, для работы с js pw-two-three-tiles.js -->
